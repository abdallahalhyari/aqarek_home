                    ...
                    children: [
                      Container(
                        ...
                        child: CarouselSlider(
                          items: homePageBloc.homePageModel!.headerGallery!
                              .map((e) => SizedBox(
                                  width: MediaQuery.sizeOf(context).width,
                                  child: Image.network(
                                    e.image ?? '',
                          ...
                          children: [
                            SizedBox(
                                ...
                                child: ListView.builder(
                                    ...
                                    itemCount: homePageBloc
                                        .homePageModel!.headerWidgets!.length,
                            ...
                            const SizedBox(height: 15),
                           OffersWidget(headerOffers: homePageBloc.homePageModel!.headerOffers!),
                                              ...
                                              itemBuilder: (context, index) => Container(
                                                  decoration: BoxDecoration(
                                                      ...
                                                      image: DecorationImage(
                                                          image: NetworkImage(
                                                              homePageBloc.homePageModel!.latestProjects!.items![index].image ?? ''),
                                                          fit: BoxFit.fill)),
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    child: ListView.builder(
                                      ...
                                      scrollDirection: Axis.horizontal,
                                      itemCount: homePageBloc
                                          .homePageModel!.units!.items!.length,
                                      itemBuilder: (context, index) =>
                                          Container(
                                        decoration: BoxDecoration(
                                            image: DecorationImage(
